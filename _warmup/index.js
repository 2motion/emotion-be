...
/** Generated by Serverless WarmUp Plugin at 2020-05-16T14:47:32.925Z */

const aws = require('aws-sdk');
aws.config.region = 'us-east-1';
const lambda = new aws.Lambda();
const functions = [{"name":"emtoion-dev-index","config":{"enabled":["production","staging","dev"],"payload":"{\"source\":\"serverless-plugin-warmup\"}","concurrency":1}}];
