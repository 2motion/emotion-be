...
const swaggerBootstrap = (app: INestApplication) => {
  ...
  const options = new DocumentBuilder()
    .setTitle('Gamstagram REST API')
    .setExternalDoc(
      'To generate and download a Swagger JSON file, Click here',
      'https://api.gamstagram.com/json',
    )
    .addServer('https://api.gamstagram.com/')
  ...
  const document = SwaggerModule.createDocument(app, options, {
    include: [ArticleModule, AuthenticationModule, MeModule],
  });
